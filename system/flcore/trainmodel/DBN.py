...
from system.flcore.trainmodel.RBM import RBM
...
class DBN(nn.Module):
    ...
    def __init__(self,
        ...
        self.fc1 = nn.Linear(self.n_hidden[-1], 56).to(device)
        self.fc2 = nn.Linear(56, 48).to(device)
        self.fc3 = nn.Linear(48, 40).to(device)
        self.fc4 = nn.Linear(40, self.n_classes).to(device)
    ...
    def fit(self, train_loader):
        ...
        input_data = torch.tensor(train_loader.dataset.features.values).cuda()
